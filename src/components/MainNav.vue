<template>
  <v-navigation-drawer color="grey lighten-5" floating class="pa-4" app permanent >
    <v-layout class="pa-1">
      <div>
        <v-img
          width="130px"
    ...
    <v-layout class="mt-10">
      <v-flex>
        <v-layout>
          <v-flex text-center>
            <!-- <v-card class="text-center" width="70" style="border-radius: 50%" outlined> -->
            ...
            <div class="mt-5">
              <v-layout>
                ...
                <v-flex>
                  <div class="subtitle-2">Following</div>
                  <div class="subtitle-2 grey--text">48m</div>
                </v-flex>
              </v-layout>
            </div>
